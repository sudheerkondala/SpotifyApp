...
var ArtistComponent = (function () {
    function ArtistComponent(_spotifyserivce, _route) {
        this._spotifyserivce = _spotifyserivce;
        this._route = _route;
    }
    ArtistComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._route.params.map(function (params) { return params['id']; }).subscribe(function (id) {
            _this._spotifyserivce.getArtist(id).subscribe(function (artist) {
                _this.artist = artist;
                console.log(_this.artist);
            });
            _this._spotifyserivce.getAlbums(id).subscribe(function (albums) {
